    ...
    <div className="max-w-4xl mx-auto space-y-8 py-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-150 pb-6">
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-2.5 pt-2">
            ...
            <h1 className="text-xs sm:text-xl md:text-3xl font-display font-black text-slate-900 uppercase tracking-tight">
              Terms & Conditions
            </h1>
          </div>
        </div>
      ...
      >
        <div className="prose prose-slate max-w-none">
          <p className="text-[9px] sm:text-xs md:text-base text-slate-600 leading-relaxed font-medium">
        ...
        <div className="space-y-8 divide-y divide-slate-100">
          ...
          <div className="space-y-3 pt-6 first:pt-0">
            <h2 className="text-xs sm:text-sm md:text-lg font-extrabold text-slate-900 flex items-center gap-2.5">
            ...
            <p className="text-[9px] sm:text-xs md:text-sm text-slate-500 leading-relaxed pl-8 font-medium">
          ...
          <div className="space-y-3 pt-6">
            ...
            <div className="pl-8 space-y-2 text-[9px] sm:text-xs md:text-sm text-slate-500 font-medium">
