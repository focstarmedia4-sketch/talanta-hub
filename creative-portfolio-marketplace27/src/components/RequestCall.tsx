      ...
      <div className="bg-slate-900 text-white rounded-3xl border border-slate-800 p-6 md:p-8 shadow-xl relative overflow-hidden transition-all duration-300">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-xl">
            ...
            <h3 className="text-xs sm:text-base md:text-xl font-black uppercase tracking-wider text-white flex items-center gap-2">
              <PhoneCall className="h-5 w-5 text-indigo-400 animate-pulse" />
              <span>Let's Discuss Your Project</span>
            </h3>
            <p className="text-[9px] sm:text-xs text-slate-300 font-medium leading-relaxed">
          ...
          <div className="shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-white hover:bg-slate-100 active:scale-95 text-slate-950 text-xs font-black uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-md flex items-center justify-center gap-2 relative z-10"
            >
              {isOpen ? <X className="h-4 w-4 text-rose-600" /> : <Phone className="h-4 w-4 text-indigo-600" />}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-2.5 py-1 bg-white/10 hover:bg-white/20 text-slate-300 hover:text-white rounded-lg transition-all cursor-pointer flex items-center gap-1 text-[10px] font-bold uppercase"
                        title="Close Panel"
                      >
                  ...
                  {successMsg ? (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => setIsOpen(false)}
                        className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer inline-flex items-center gap-1.5"
                      >
                        <X className="h-4 w-4" />
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="flex items-center justify-between pb-2 border-b border-white/5">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[9px] text-slate-500 font-bold uppercase hidden sm:inline">
                            All fields required *
                          </span>
                          <button
                            type="button"
                      ...
                      <div className="flex items-center justify-end gap-2 pt-1">
                        <button
                          type="button"
                          onClick={() => setIsOpen(false)}
                          className="px-4 py-2.5 bg-white/10 hover:bg-white/20 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer flex items-center gap-1.5"
                        >
                          <X className="h-4 w-4" />
                          <span>Close</span>
                        </button>
