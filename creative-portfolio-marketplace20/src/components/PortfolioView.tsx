...
export default function PortfolioView({ 
  ...
  useEffect(() => {
    if (selectedGalleryItem) {
      const targetUrl = `${window.location.origin}/profile/${profile.username || profile.id}?item=${selectedGalleryItem.id}`;
      if (!window.location.href.includes(`item=${selectedGalleryItem.id}`)) {
