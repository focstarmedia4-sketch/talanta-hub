              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-0.5">
                    <span className="font-bold text-xs sm:text-sm text-slate-900 truncate">{chatName}</span>
                    <span className="text-[9px] sm:text-[10px] font-semibold text-slate-400 shrink-0">{conv.lastMessageTime}</span>
                  </div>
                  <p className="text-[9px] sm:text-xs text-slate-500 truncate pr-4 leading-normal">
